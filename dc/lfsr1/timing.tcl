...
if {[sizeof_collection [get_ports clk1]] > 0} {
  ...
  set_drive 0 [get_clocks $clk_name_1] 
}
...
if {[sizeof_collection [get_ports clk2]] > 0} {
  ...
  set_drive 0 [get_clocks $clk_name_2] 
}
...
set_dont_touch_network $clk_port_1
set_dont_touch_network $clk_port_2
 
set_ideal_network $clk_port_1
set_ideal_network $clk_port_2
...
remove_input_delay -clock $clk_name [find port $clk_port_1]
remove_input_delay -clock $clk_name [find port $clk_port_2]
...
group_path -name -from [all_inputs] -to [all_outputs] 
